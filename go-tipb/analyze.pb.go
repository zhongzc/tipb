...
type AnalyzeIndexReq struct {
	...
	ColumnsInfo      []*ColumnInfo `protobuf:"bytes,5,rep,name=columns_info,json=columnsInfo" json:"columns_info,omitempty"`
	XXX_unrecognized []byte        `json:"-"`
}
...
func (m *AnalyzeIndexReq) GetColumnsInfo() []*ColumnInfo {
	if m != nil {
...
var fileDescriptorAnalyze = []byte{
	...
	,
}
