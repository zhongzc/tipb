...
const (
	...
	TracingEvent_TiKvCoprTopNExecutorNextBatch         TracingEvent = 1012
	TracingEvent_TiKvCoprStreamAggrExecutorNextBatch   TracingEvent = 1013
	TracingEvent_TiKvCoprFastHashAggrExecutorNextBatch TracingEvent = 1014
	TracingEvent_TiKvCoprSimpleAggrExecutorNextBatch   TracingEvent = 1015
	TracingEvent_TiKvCoprSlowHashAggrExecutorNextBatch TracingEvent = 1016
	// RawGet
...
var TracingEvent_name = map[int32]string{
	...
	1012: "TiKvCoprTopNExecutorNextBatch",
	1013: "TiKvCoprStreamAggrExecutorNextBatch",
	1014: "TiKvCoprFastHashAggrExecutorNextBatch",
	1015: "TiKvCoprSimpleAggrExecutorNextBatch",
	1016: "TiKvCoprSlowHashAggrExecutorNextBatch",
	1100: "TiKvRawGet",
	1101: "TiKvRawGetTask",
...
var TracingEvent_value = map[string]int32{
	...
	"TiKvCoprTopNExecutorNextBatch":         1012,
	"TiKvCoprStreamAggrExecutorNextBatch":   1013,
	"TiKvCoprFastHashAggrExecutorNextBatch": 1014,
	"TiKvCoprSimpleAggrExecutorNextBatch":   1015,
	"TiKvCoprSlowHashAggrExecutorNextBatch": 1016,
	"TiKvRawGet":                            1100,
	"TiKvRawGetTask":                        1101,
...
var fileDescriptorTracing = []byte{
	...
	,
}
